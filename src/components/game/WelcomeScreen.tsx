    ...
    return (
      <div className="relative min-h-screen min-h-[100dvh] game-gradient flex flex-col items-center justify-center px-4 py-4 overflow-hidden gap-3">
        ...
        <div className="flex flex-col items-center gap-2">
          <button 
            onClick={() => setShowRizzScene(true)} 
            className="bg-pink-500 backdrop-blur-sm rounded-2xl px-8 py-4 border border-pink-400/50 animate-pulse shadow-lg cursor-pointer hover:bg-pink-600 transition-colors active:scale-95"
          >
    ...
    <div className="relative min-h-screen min-h-[100dvh] game-gradient flex flex-col items-center justify-center px-4 py-4 overflow-hidden">
      ...
      <div className="flex items-start justify-center gap-6 md:gap-12 mb-6">
        ...
        <div className="flex flex-col items-center animate-fade-in" style={{ animationDelay: '0.2s' }}>
          ...
          {/* Speech Bubble */}
          <div className="relative bg-white rounded-xl px-4 py-3 mt-4 shadow-lg max-w-[160px] animate-speech-bubble" style={{ animationDelay: '0.5s' }}>
        ...
        <div className="flex flex-col items-center animate-fade-in" style={{ animationDelay: '0.4s' }}>
          ...
          <div className="relative bg-white rounded-xl px-4 py-3 mt-4 shadow-lg animate-speech-bubble" style={{ animationDelay: '0.8s' }}>
            {/* Bubble tail pointing up */}
            <div className="absolute -top-2 left-1/2 -translate-x-1/2 w-0 h-0 border-l-8 border-r-8 border-b-8 border-l-transparent border-r-transparent border-b-white" />
      ...
      {/* Tap to start + Footer */}
      <div className="flex flex-col items-center gap-2 animate-fade-in" style={{ animationDelay: '1.2s' }}>
        <button 
          onClick={onStart} 
