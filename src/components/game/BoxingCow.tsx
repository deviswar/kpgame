...
const BoxingCow = ({
  ...
  const getBodyLean = () => {
    switch (punchPhase) {
      case 'windup':
        return 'rotate(8deg) translateX(-5px)';
      // Lean back
      case 'rushing':
        return 'rotate(-12deg) translateX(5px)';
      // Lean forward aggressively
      case 'arm-raise':
        return 'rotate(-8deg) translateX(3px)';
      case 'strike':
        return 'rotate(-15deg) translateX(8px)';
      // Full forward lean
      case 'recovery':
  ...
  return <div style={{
    transform: 'scaleX(-1)'
  }}> {/* Wrapper to flip cow to face right */}
      <div className={`relative transition-transform ${getAnimationClass()} ${getMotionBlur()}`} style={{
      width: width,
      height: height,
      ...
      {punchPhase === 'rushing' && <div className="absolute inset-0 pointer-events-none overflow-visible">
          {[...Array(4)].map((_, i) => <div key={i} className="absolute bg-gradient-to-r from-yellow-300/60 to-transparent" style={{
          width: '60px',
          height: '3px',
          left: `-${40 + i * 15}px`,
          top: `${30 + i * 25}%`,
      ...
      {/* Body */}
      <div className="absolute rounded-[60%] overflow-hidden" style={{
        width: width * 0.85,
        height: height * 0.45,
        bottom: height * 0.2,
        left: '50%',
      ...
      <div className="absolute rounded-b-lg" style={{
        ...
        <div className="absolute bottom-0 left-1/2 -translate-x-1/2 rounded" style={{
          width: width * 0.14,
          height: height * 0.04,
          background: '#1a1a1a'
        }} />
      ...
      <div className="transition-transform" style={{
        ...
        transitionTimingFunction: punchPhase === 'strike' ? 'cubic-bezier(0.22, 1, 0.36, 1)' : 'ease-out'
      }}>
        {/* Leg segment */}
        <div className="absolute top-0 w-full rounded-lg" style={{
          height: '65%',
          background: 'linear-gradient(135deg, #f0f0e8, #e8e8e0)',
          border: '1px solid #ccc'
        }} />
        {/* Boxing Glove */}
        <div className={`absolute transition-transform ${punchPhase === 'strike' ? 'scale-110' : 'scale-100'}`} style={{
          bottom: 0,
          left: '50%',
          transform: 'translateX(-50%)',
          width: width * 0.16,
          ...
          {/* Glove shine */}
          <div className="absolute rounded-full bg-white/50" style={{
            top: '12%',
            left: '18%',
            width: '28%',
            height: '24%'
      ...
      <div className="absolute transition-transform duration-100" style={{
        width: width * 0.09,
        height: height * 0.22,
        bottom: height * 0.15,
        left: width * 0.28,
        ...
        <div className="absolute rounded-full" style={{
          ...
          <div className="absolute top-1 left-2 rounded-full bg-white/30" style={{
            width: width * 0.04,
            height: width * 0.025
          }} />
        </div>
      ...
      <div className="absolute" style={{
        ...
        <div className="absolute rounded-[45%]" style={{
          width: '100%',
          height: '100%',
        ...
        {/* Horns */}
        <div className="absolute -top-3 left-2 rounded-t-full" style={{
          width: width * 0.06,
          height: height * 0.1,
          background: 'linear-gradient(to top, #8b7355, #d4c4a8)',
          transform: 'rotate(-20deg)'
        }} />
        <div className="absolute -top-3 right-3 rounded-t-full" style={{
          width: width * 0.06,
          height: height * 0.1,
          background: 'linear-gradient(to top, #8b7355, #d4c4a8)',
          transform: 'rotate(20deg)'
        ...
        <div className="absolute top-2 -right-1 rounded-full" style={{
          width: width * 0.12,
          height: height * 0.06,
          background: 'linear-gradient(145deg, #f5f5f0, #e0e0d8)',
          transform: 'rotate(30deg)'
        ...
        <div className="absolute top-[32%] left-1/2 -translate-x-1/2 flex gap-3">
          ...
          <div className="relative">
            ...
            <div className="absolute -top-1.5 left-1/2 -translate-x-1/2 h-1 rounded-full transition-transform duration-100" style={{
              width: width * 0.09,
              background: '#4a4a4a',
              transform: `translateX(-25%) ${punchPhase === 'strike' ? 'rotate(18deg)' : isPunching ? 'rotate(15deg)' : 'rotate(12deg)'}`,
              transformOrigin: 'right center'
            }} />
            <div className="rounded-full bg-white flex items-center justify-center" style={{
              width: width * 0.09,
              height: width * 0.09,
              border: '2px solid #d0d0d0'
            }}>
              <div className="rounded-full bg-gray-900" style={{
                width: width * 0.045,
                height: width * 0.045
              }}>
        ...
        {/* Snout/Nose */}
        <div className="absolute bottom-1 left-1/2 -translate-x-1/2 rounded-[50%]" style={{
          width: width * 0.25,
          height: height * 0.1,
          ...
          <div className="absolute top-1/2 left-1/4 -translate-y-1/2 flex gap-2">
            <div className={`rounded-full bg-gray-800 transition-transform duration-100 ${punchPhase === 'strike' ? 'scale-150' : isPunching ? 'scale-125' : ''}`} style={{
              width: width * 0.04,
              height: height * 0.03
            }} />
            <div className={`rounded-full bg-gray-800 transition-transform duration-100 ${punchPhase === 'strike' ? 'scale-150' : isPunching ? 'scale-125' : ''}`} style={{
        ...
        <div className="absolute -bottom-1 left-1/2 -translate-x-1/2 transition-all duration-100" style={{
      ...
      {punchPhase === 'strike' && <div className="absolute pointer-events-none" style={{
        left: width * 0.3,
        bottom: height * 0.15,
        zIndex: 20
      }}>
          <div className="relative">
            ...
            <span className="absolute -top-2 -left-2 text-xl" style={{
            animation: 'impact-burst 0.3s ease-out forwards'
          }}>
              ✨
            </span>
            <span className="absolute -top-1 left-4 text-lg" style={{
            animation: 'impact-burst 0.3s ease-out 0.1s forwards'
          }}>
              ⚡
            </span>
          </div>
      ...
      {isVictory && <div className="absolute -top-4 left-1/2 -translate-x-1/2 text-2xl animate-bounce">
          🏆
        </div>}
      </div>
    </div>;
